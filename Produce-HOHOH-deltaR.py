...
if len(sys.argv)<4:
    print 'Usage: ./HOHOH-groundState.py N_size nReps descendantSteps nRepsDW nStartforNReps'
    end
...
###UPDATE HERE!###
molecule='H3O2'
Wfn.setNodalSurface('SharedProton','Both')
state='stateDeltaR'
DWstate='DWDeltaR'
#################
...
plt.savefig(path+'CoordinateProjection-'+fileParameterName+'.png')
plt.clf()
#plt.show()
